...
function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white p-8 flex flex-col items-center justify-center font-sans overflow-hidden">
      <div className="w-full max-w-8xl h-full flex flex-row-reverse items-center justify-center gap-16">
        ...
        {/* Tablero de Números */}
        <div className="w-full h-full grid grid-cols-15 gap-3 p-8 bg-neutral-900/50 rounded-3xl border border-neutral-800">
